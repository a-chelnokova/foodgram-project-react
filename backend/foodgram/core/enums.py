...
class Tuples(tuple, Enum):
    ...
    # Например, только не в избранном: 'is_favorited=0'
...
class Limits(IntEnum):
    ...
    # Максимальная длина единицы измерения моделей в приложении "recipes"
...
class UrlQueries(str, Enum):
    ...
    SHOP_CART = 'is_in_shopping_list'
    # Параметр для поиска объектов по автору
    AUTHOR = 'author'
    # Параметр для поиска объектов по тегам
    TAGS = 'tags'
