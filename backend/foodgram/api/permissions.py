...
class AuthorStaffOrReadOnly(BanPermission):
    """
    Разрешение на изменение объекта только для автора и персонала.
...
class AdminOrReadOnly(BanPermission):
    """
    Разрешение на создание и изменение объектов только для админов.
    Остальным только чтение.
    """
    def has_object_permission(
        self,
...
class OwnerUserOrReadOnly(BanPermission):
    """
    Разрешение на создание и изменение объекта только для админа и пользователя.
    Остальным только чтение.
    """
    def has_object_permission(
        self,
